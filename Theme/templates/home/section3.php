<div class="section section3">
  <div class="container">
    <h1 class="sectionTitle">기술 적용 제품</h1>
    <p class="excerpt">풍원정밀의 핵심기술은 모바일, TV등의 디스플레이에 적용되고있으며<br />
      미래 신성장의 핵심 원동력이 되고 있습니다. </p>
    <div class="row gap-0">
      <div class="p-0 col-6">
        <div class="coverCard">
          ...
          <div class="content">
            <div class="innerWrap">
              <div class="title">올레드 TV</div>
              <p>
                90년대 이후 반도체 핵심 부품을 거쳐 2000년대에는 세계적 수준의 디스플레이 핵심 부품을 생산하고 있습니다.
              </p>
            </div>
          </div>
        </div>
