...
<main class="pageTemplate fmm">
  ...
  <div class="section section1">
    <div class="bgCover">
      <img draggable="false" src="<?php echo $zeplin ?>/fmm-img01.jpg" >
    </div>
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8 col-xs-12 contentCol">
          <p>
          오픈 메탈 마스크(OMM, Open Metal Mask)가 OLED 기판에 기능적인 역할을 하는 유기막을 디스플레이 전면에 증착하기 위해 사용되는 부품인데 비해서,
  ...
  <div class="section section2">
    <div class="bgCover">
      <img draggable="false" src="<?php echo $zeplin ?>/fmm-img02.jpg">
    </div>
    <div class="container">
      <div class="row">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-7 col-xs-12 imgCol">
          <img draggable="false" src="<?php echo $zeplin ?>/fmm-img03.jpg" >
        </div>
