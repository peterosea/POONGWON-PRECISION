    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-8 contentCol">
          <p>
          풍원정밀은 OLED TV를 제작하는데 있어 유기물을 증착하기 위한 바(Bar) 형태의 메탈 마스크를 제작하고 있습니다.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-5 contentCol">
          ...
          <p class="head">
          풍원정밀은 스틱바 마스크 설계시 기판과의 간격을 유지하기 위한 돌기 형태의 구조물(지지대)을 고안하여 특허로 등록하였으며, 작업에 있어서 최소한의 오차 범위로 업계에서 뛰어난 기술력을 인정받고 있습니다.
          </p>
        </div>
        <div class="col-7"></div>
      </div>
