  ...
  <div class="section section1">
    <div class="container">
      <div class="row">
        <div class="col">
          <p>
            풍원정밀은 25년간 박막 메탈에 대한 Wet-Etching 공정의 개발 및 양산을 지속해 온 첨단 부품 제조업체입니다. 반도체, 디스플레이 제조과정에서 꼭 필요한 핵심소재를 얇은 철판을 이용해 고부가가치 제품으로 가공하는 기술을 가지고 있습니다.
          </p>
        </div>
        <div class="col">
          <p>
            최근 풍원정밀이 디스플레이 시장에서 주목 받는 이유는 색과 화질이 뛰어나고 얇고 플렉서블(Flexible)하게 만들 수 있어 차세대 디스플레이로 각광 받으며 최근 급성장하고 있는 OLED(유기발광다이오드) 디스플레이 제조 공정의 핵심 소재들을 생산, 공급하고 있기 때문이다.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-5">
          ...
          <p>
            Wet-Etching을 이용한 FMM 제작은 일반적으로 금속 판을 롤 형태로 장비에 연결하여 연속적으로 생산이 가능한 Roll-to Roll방식이 적용됩니다. 이 과정에서 얇은 금속판은 미세하게 변형이 발생하게 되고, 이를 그대로 가공할 경우 불량이 발생한다. 풍원정밀은 제조 과정에서 일어나는 변형을 분석한 설계 보정기술을 가지고 제품 불량을 최소화하고 있습니다.
          </p>
        </div>
        <div class="col-7">
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-5">
          ...
          <p>
            FMM의 공정에 따라 에칭 면의 부식을 방지하기 위해 액상의 합성수지(resin)를 도포하게 됩니다. 이때 합성수지의 배합, 코팅 두께, 건조 조건에 따라서 FMM의 미세 구멍이 둔턱 높이 및 패턴이 달라질 수 있습니다. 풍원정밀은 폴리우레탄계의 고분자 물질을 넣은 새로운 합성수지 배합을 개발하여 더욱 정밀한 FMM을 생산하고 있습니다.
          </p>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-5">
          ...
          <p>
            FMM제조에 있어서 PR(Photo Resist) 선정은 공정설계 및 기술개발의 시작점이 되는 중요한 재료입니다. 액상 PR은 건조된 형태의 PR보다 코팅기판에 대한 접착력이 우수한테, 표면 조도가 높아 접착이 어려운 금속 표면에 코팅했을 때 더욱 효과가 뛰어납니다. 풍원정밀은 액상 PR로 금속을 코팅하기 전 금속의 거칠기를 조절할 수있는 약품을 자회사인 풍원화학과 공동 개발하여 액상 PR의 장점을 극대화하였습니다.
          </p>
          <h1 class="title">Fine Etching Technology</h1>
          <h2 class="subTitle">(정교한 에칭 기술)</h2>
          <p>
            오픈메탈마스크(OMM) 또는 스틱바마스크(SBM)에 비교해서 파인메탈마스크(FMM)는 매우 섬세하고 정교한 공정 및 기술 수준을 요합니다. 풍원정밀은 OMM/SBM 개발 과정에서 확보한 에칭 기술을 발전시켜 FMM을 위한 미세 에칭 기술을 개발하였습니다. 풍원정밀은 새로운 방식의 2스텝 공정을 적용하여 에칭 후 정확한 사이즈와 둔턱을 확보하여 정밀한 FMM을 생산하고 있습니다.
          </p>
        </div>
        <div class="col-7">
        </div>
