    ...
    <div class="container">
      <div class="row">
        <div class="col-5">
          ...
          <p>
          Wet-Etching을 이용한 FMM 제작은 일반적으로 금속 판을 Roll 형태로 장비에 연결하여 연속적으로 생산이 가능한 Roll-to Roll방식이 적용됩니다. 이 과정에서 얇은 금속판은 미세하게 변형이 발생하게 되고, 이를 그대로 가공할 경우 불량이 발생합니다. 
...
유리합니다. 풍원정밀은 액상 PR로 금속을 코팅하기 전 금속표면의 거칠기를 조절할 수있는 약품을 자회사인 풍원화학과 공동 개발하여 액상 PR의 장점을 극대화하였습니다. 
          ...
          <p>
          오픈메탈마스크(OMM) 또는 스틱바마스크(SBM)에 비교해서 파인메탈마스크(FMM)는 매우 섬세하고 정교한 공정 및 기술 수준을 요합니다. 풍원정밀은 OMM/SBM 개발 과정에서 확보한 에칭공정 기술을 발전시켜 FMM을 위한 미세 에칭 공정 기술을 개발하였습니다. Roll to Roll 공정 단계별로 공정변수를 최적화하여 얇은 메탈 박막이 이동하면서 발생할 수 있는 오차를 최소화하였습니다.
          </p>
        </div>
        <div class="col-7">
        </div>
